class ApiUrl {
  // static const String baseUrl = 'https://sami01995-001-site1.ltempurl.com/api';
  static const String baseUrl = 'http://kar.runasp.net/api';
  static const String signupUrl = '$baseUrl/Users'; // for signup
